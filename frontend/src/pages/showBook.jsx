...
const ShowBook = () => {
  ...
  useEffect(() => {
    ...
    .then((response) => {
      ...
      enqueueSnackbar("Book is fetch successfully");
      setLoading(false);
    })
    .catch((error) => {
      enqueueSnackbar("unavailbe to fetch data");
      console.log(error);
    })
  ...
  return (
    <div className='p-4'>
      ...
      {loading ? (
        ...
        <div className='flex flex-col border-2 border-sky-400 rounded-x2 w-fit p-4'>
          <div className='my-4'>
